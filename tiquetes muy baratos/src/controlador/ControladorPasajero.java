...
//---------------------------------------------------------BORRAR PASAJERO---------------------------------------------------------------------
		...
		if (e.getSource().equals(vista.btnBorrar)) {
			...
			if (modelo.buscarIndex(pasajero) != -1) {
				if (modelo.delete(pasajero))
					JOptionPane.showMessageDialog(null, "Se elimino correctamente el pasajero de la agencia");
			} else
				JOptionPane.showMessageDialog(null, "El pasajero nunca fue registrado en la agencia");
		}
	}
}
